...
class GoodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create good" do
    assert_difference("Good.count") do
      post goods_url, params: { good: { price: @good.price, status_received: @good.status_received, weight: @good.weight } }
    end
  ...
  test "should update good" do
    patch good_url(@good), params: { good: { price: @good.price, status_received: @good.status_received, weight: @good.weight } }
