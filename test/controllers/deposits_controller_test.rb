...
class DepositsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deposit" do
    assert_difference("Deposit.count") do
      post deposits_url, params: { deposit: { amount: @deposit.amount, customer_id: @deposit.customer_id, date: @deposit.date } }
    end
  ...
  test "should update deposit" do
    patch deposit_url(@deposit), params: { deposit: { amount: @deposit.amount, customer_id: @deposit.customer_id, date: @deposit.date } }
